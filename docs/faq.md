...
**Fix:** Look at the Settings page for an Ampio repair before you do anything else. If your module devices lost their names and areas at the same time, follow [My module devices lost their names, areas and labels](#my-module-devices-lost-their-names-areas-and-labels) and submit the repair it describes. If a repair lists the entities for another reason, [An entity is listed that Ampio Designer no longer has](#an-entity-is-listed-that-ampio-designer-no-longer-has) explains each one.
