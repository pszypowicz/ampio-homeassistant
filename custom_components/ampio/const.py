...
# Registry records no catalogue this account received accounts for.
...
# drift apart, and so the stale report reads module records back through
# the same stem the entity builds its key with.
